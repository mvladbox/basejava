...
# Изучайте [первое открытое занятие](lesson/lesson01.md).
...
### Открытое занятие 1
 - [Презентация проекта](lesson/lesson01.md#-Вебинар-ПРЕЗЕНТАЦИЯ-обучения)
 - [Разработка ПО](lesson/lesson01.md#-1-Разработка-ПО)
 - [Обзор языка Java](lesson/lesson01.md#-3-Обзор-языка-java)
 - [Системы управления версиями. Git](lesson/lesson01.md#-4-Системы-управления-версиями-git)
 - [ПЕРВОЕ ДОМАШНЕЕ ЗАДАНИЕ](lesson/lesson01.md#Домашнее-задание-hw1)

### Занятие 2
 - [Принципы ООП](lesson/lesson02.md#Принципы-ООП)
 - [Структура памяти: куча, стек, регистры, константы](lesson/lesson02.md#Структура-памяти-куча-стек-регистры-константы)
 - [Типы данных. Пакеты](lesson/lesson02.md#Типы-данных-Пакеты)

### Занятие 3
 - [Объектная модель в Java](lesson/lesson03.md#Объектная-модель-в-java)
 - [Сложность алгоритмов](lesson/lesson03.md#Сложность-алгоритмов)
 - [Паттерн проектирования Шаблонный метод](https://github.com/JavaOPs/JavaSE-Web/blob/master/lesson/lesson03.md#Паттерн-проектирования-Шаблонный-метод)
 
### Занятие 4
 - [Работа со строками](lesson/lesson04.md#Работа-со-строками)
 - [Исключения](lesson/lesson04.md#Исключения)
 - [Reflection. Аннотации. Модульное тестирование](lesson/lesson04.md#reflection-Аннотации-Модульное-тестирование)

### Занятие 5
 - [Контейнеры/коллекции](lesson/lesson05.md#Контейнерыколлекции)
 
### Занятие 6
 - [Iterator / Iterable. Вложенные, внутренние, локальные и анонимные классы](lesson/lesson06.md#iterator--iterable-Вложенные-внутренние-локальные-и-анонимные-классы)
 - [Новое в Java 8](lesson/lesson06.md#Новое-в-java-8)

### Занятие 7
 - [Параметризация. Стирание типов](lesson/lesson07.md#Параметризация-Стирание-типов)
 - [Логирование](lesson/lesson07.md#Логирование)
 - [Синглетон, Enum](lesson/lesson07.md#Синглетон-enum)

### Занятие 8
 - [Работа с датами и временем](lesson/lesson08.md#Работа-с-датами-и-временем)
 - [Работа с файлами и ресурсами](lesson/lesson08.md#Работа-с-файлами-и-ресурсами)

### Занятие 9
 - [Ввод/вывод](lesson/lesson09.md#Вводвывод)
 - [Сериализация](lesson/lesson09.md#Сериализация)
 - [NIO](lesson/lesson09.md#nio)
 - [Основы Java 8 Stream API](lesson/lesson09.md#Основы-java-8-stream-api) 
