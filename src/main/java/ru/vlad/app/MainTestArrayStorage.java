...
import ru.vlad.app.storage.SortedArrayStorage;
...
public class MainTestArrayStorage {
    ...
    public static void main(String[] args) {
        Resume r1 = new Resume("uuid1", "Fullname One");
        Resume r2 = new Resume("uuid2", "Fullname Two");
        Resume r3 = new Resume("uuid3", "Fullname Three");
